    ...
    <main className="shell">
      <section className="hero">
        <div className="hero__copy">
          ...
          <h1>Зберіть акуратний PDF-каталог із таблиці за кілька хвилин.</h1>
          <p>
            Завантажте Excel, CSV або вставте публічне посилання на Google Sheets. Сервіс
            перевірить дані, оформить каталог у вибраному стилі та підготує PDF для
            завантаження.
          </p>
          <div className="hero__meta">
            <span>2 стилі оформлення</span>
            <span>Підготовлено для A4</span>
            <span>Швидкий старт із demo-файлом</span>
          </div>
        </div>
        ...
        <div className="hero__card">
          ...
          <ul>
            ...
            <li>
              Додаткові поля: <code>sku</code>, <code>brand</code>, <code>category</code>,{" "}
              <code>price</code>
            </li>
            <li>
